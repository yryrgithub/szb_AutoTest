...
from test.page.HistoryRequestPage import HistoryRequestPage
from utils.readConfig import ReadConfig


class TestHistoryRequestPage(unittest.TestCase):
    data = ReadConfig().get_account()
    report_path = data["report_path"]

    @classmethod
    def setUpClass(cls):
        cls.home = HistoryRequestPage()
        cls.home.login_base()
        MultiMenuOperation(driver=cls.home.driver).select_menu('历史调用')
    ...
    def test_home08_download1(self):
        self.home.history_request_download(self.report_path)
